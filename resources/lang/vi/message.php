<?php
return [
//   Bắt đầu  dịch nội dung phần Header.
    "login" => "Đăng nhập",
    "logout" => "Đăng xuất",
    "register" => "Đăng ký",
    "search" => "Tìm kiếm...",
    ...
    "aboutus" => "Giới Thiệu",
    "contact" => "Liên Hệ",
//   Kết thúc translate phần Header.

//  Bắt đầu dịch nội dung trang Home.
    "homepage" => "Trang chủ",
...
// Bắt đầu dich phần Footer
    ...
    "luxury_watch" => "Tự hào là nhà phân phối các thương hiệu đồng hồ Thụy Sĩ chính hãng sang trọng duy nhất tại Việt Nam",
    "information" => "Thông tin",
    "about_us_footer" => "Về chúng tôi",
    "transport_info" => "Thông tin vận chuyển",
    "terms" => "Điều khoản và Điều kiện",
    "contact_footer" => "Liên hệ chúng tôi",
    ...
    "account_footer" => "Tài khoản",
    "my_account_footer" => "Tài khoản của tôi",
