    ...
    <div class="table-wrapper">
        ...
        <div class="row" style="margin-top: 1rem; margin-bottom: 1rem;">
            ...
            <div class="col-md">
                ...
                <div class="as-track-button" data-size="large" data-domain="tiendxd00674fpt.aftership.com"></div>
            </div>
        </div>
        <form action="{{ route('bills') }}" method="get" style="margin-bottom: 2rem;">
            ...
            <div style="text-align: center;">
                ...
                <a href="{{ route('addBillForm') }}" class="btn btn-success"><span>Thêm đơn hàng</span></a>
            </div>
        </form>
            ...
            @foreach($Bills as $bill)
                <tr>
                    ...
                    <td class="edit-delete-block">
                        <a href="{{ route('addBillForm', ['id' => $bill->id]) }}" class="edit"><i class="material-icons" title="Sửa">&#xE254;</i></a>
